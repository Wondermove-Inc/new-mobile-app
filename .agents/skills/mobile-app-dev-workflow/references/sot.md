...
- Role SOUL (this role): `mobile-app-dev-team/runtime-sources/role-souls/mobile-app-dev-soul.md`
- Codex runtime policy and facts: `REPO_OPERATIONS.md`, `PROJECT_ENVIRONMENT.md`
- This workflow skill: `.agents/skills/mobile-app-dev-workflow/SKILL.md`
