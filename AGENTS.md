...
- Pod-native OpenClaw skill-only requests use `/workspace/skills/<slug>/SKILL.md` as the runtime shape and are authored under `mobile-app-dev-team/runtime-sources/skills/<slug>/` using skill-creator structure.
