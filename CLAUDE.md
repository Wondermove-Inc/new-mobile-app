...
- **Skill** (one concept; `SKILL.md` folder): Codex `.agents/skills/<name>/SKILL.md` · Claude `.claude/skills/<name>/SKILL.md` · Pod-native OpenClaw `/workspace/skills/<slug>/SKILL.md` (authored under `mobile-app-dev-team/runtime-sources/skills/<slug>/`). "pod agent skills" = pod-native skills, not agents.
