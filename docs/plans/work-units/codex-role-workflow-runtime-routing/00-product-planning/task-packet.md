...
058. Durable pod handoff: `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md`.
...
137. `codex-role-workflow` currently lacks a compact `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` operational overlay.
...
141. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says every user input enters Product/Planning intake first.
142. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says no input routes directly to an execution role.
143. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps unclear input to `po-requirement-office-hours`.
144. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps broad input to `po-work-unit-planning-and-agent-sprint`.
145. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps ready input to `po-prd-to-execution`.
146. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps pre-execution input to `po-planning-completeness-review`.
147. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` names modification requests.
148. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` names issue, bug, or failure requests.
149. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` names direct implementation language.
150. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` names proactive reports.
151. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` treats C1-C5 as a report-derived grouping, not the authoritative SoT-named categories.
152. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says the authoritative classification is the SoT-named categories.
153. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps C4 to Design only when layout, interaction, or visual hierarchy matters.
154. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` warns that screen presence alone is not the trigger.
155. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` maps C5 by relevance, not by a fixed "no screen" shortcut.
156. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` lists E1-E16 expanded routing cases.
157. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` defines work-unit decision enum values.
158. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` defines P-1 Design relevance and `not-applicable` criteria.
159. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says `01-design` may be `not-applicable` only when no layout, interaction, or visual hierarchy is introduced or changed.
160. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says Product/Planning classifies Design relevance during planning completeness review.
161. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says Product/Planning does not own Design quality.
162. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says uncertain Design relevance defaults to relevant.
163. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says a text-only or ASCII description never authorizes implementation when layout, interaction, or visual hierarchy is in scope.
164. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says the durable `non-goal` evidence requirement for `01-design not-applicable` is deterministically enforced.
165. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` defines P-2 cross-work-unit prioritization and conflict.
166. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says Product/Planning owns prioritization and conflict resolution as scope owner.
167. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says API contract conflicts route to Backend/API Integrator with Mobile Architect co-review.
168. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says irreversible scope tradeoffs escalate to human gate.
169. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` defines P-3 emergency hotfix as expedited but still gated.
170. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says emergency hotfix still enters Product/Planning intake.
171. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says tests-first still applies to emergency hotfixes.
172. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says production submit still requires recorded human approval.
173. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says expedited means prioritization and compression of non-gating steps, not skipping required gates.
174. `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` says failed-gate shipping requires `failed-gate-risk` human gate.
...
181. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says CPO/Product Delivery Lead receives the user request through Product/Planning.
182. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says if unclear, run `po-requirement-office-hours`.
183. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says if broad, run `po-work-unit-planning-and-agent-sprint`.
184. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says if ready, run `po-prd-to-execution`.
185. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says before execution, run `po-planning-completeness-review`.
186. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says route technical decisions to Mobile Architect when architecture, runtime, API, route/state, dependency, or releaseability risk exists.
187. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says route human gates before execution work.
188. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says pod-isolated role work uses durable GitHub handoff root under `docs/plans/work-units/<work-unit-id>/`.
189. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says Design readiness requires DESIGN.md decision, P0, P1, extraction/publication, and `design-reviewer`.
190. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says API readiness updates or confirms `packages/contracts`.
191. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says implementation adds or updates the narrowest failing test/eval/validator/fixture first.
192. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says implementation is by the owning role and not delegated to write-capable executor.
193. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says QA/Release creates an E2E/evidence plan, runs evidence, records outputs, and classifies failures.
194. `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md` says production submit requires recorded human approval.
...
206. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says pod-isolated role agents have no shared storage assumption.
207. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says durable handoff must happen through GitHub branch/commit/PR or merged repo artifact.
208. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` defines the durable work-unit root.
209. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` defines work-unit stage directories.
210. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says each role artifact must include status, PRD acceptance line or non-goal reference, owner, input artifact, output artifact, acceptance criteria, evidence requirement, dependencies/blockers, open decisions, next responsible role, and GitHub branch/PR handoff link when leaving the pod.
211. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says optional backend, Railway, EAS, native, and mobile-mcp files are not mandatory unless touched.
212. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says Product/Planning owns top-level work-unit packet and routing.
213. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says Product/Planning must not implement app, backend, design, QA, or release work.
214. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says Design owns Design quality and Stitch-backed implementation handoff.
215. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says for UI work, Mobile App Dev must not start until P0, exactly two Stitch options, P1, no pre-P1 HTML extraction, and `design-reviewer` evidence exist.
216. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says actual API schemas remain in `packages/contracts`.
217. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says actual mobile code remains in `apps/mobile`.
218. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says QA/Release files summarize and link canonical evidence.
219. `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md` says PR workflow merges require applicable CI, reviewer evidence, QA evidence, and human-gate decisions.
...
237. It does not yet operationalize `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
292. In scope: make `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` operationally consumed by `codex-role-workflow`.
...
340. Task B input artifact: `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
358. Task C input artifact: `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md`.
359. Task C input artifact: `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` P-1.
...
376. Task D Done-when: check fails if `codex-role-workflow` does not reference `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
432. This section must name `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
433. This section must name `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md`.
434. This section must name `mobile-app-dev-team/governance/gates-and-evidence.md`.
435. This section must name `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md`.
...
438. This section must say `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` supplies taxonomy.
...
518. The validator must check `codex-role-workflow` references `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
561. The review prompt must include `AGENTS.md`, `REPO_OPERATIONS.md`, `PROJECT_ENVIRONMENT.md`, `codex-role-workflow`, `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`, `mobile-app-dev-team/runtime-sources/workflows/Product_Planning_WORKFLOW.md`, `mobile-app-dev-team/governance/gates-and-evidence.md`, `mobile-app-dev-team/runtime-sources/workflows/github-artifact-workflow.md`, and `mobile-app-dev-team/governance/app-eas-ota-rollback-runbook.md`.
...
571. Risk R1: duplicating `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` too fully creates divergent SoT.
572. Mitigation R1: include compact operational rules and cite `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` as process source.
573. Risk R2: only linking `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md` leaves `codex-role-workflow` non-operational.
...
622. Step 2: Re-read `AGENTS.md`, `REPO_OPERATIONS.md`, `PROJECT_ENVIRONMENT.md`, `codex-role-workflow`, and `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
646. AC6: The plan document states that `codex-role-workflow` must operationalize `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
663. The reviewer prompt must ask whether the plan correctly operationalizes `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
...
678. The reviewer prompt must include `mobile-app-dev-team/runtime-sources/workflows/entry-case-routing.md`.
