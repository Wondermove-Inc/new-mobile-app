...
`mobile-app-dev-team/02-role-souls/design-soul.md` must set itself up and
operate after reading `mobile-app-dev-team/09-pod-native-openclaw-skills/README.md`.
...
repo source of pod-native skills
  mobile-app-dev-team/09-pod-native-openclaw-skills/<slug>/SKILL.md
        |
...
Recommended aligned Design values:
...
If `mobile-app-dev-team/19-entry-case-routing.md`, root `DESIGN.md`, or the
