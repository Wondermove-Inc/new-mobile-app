...
`mobile-app-dev-team/02-role-souls/mobile-architect-soul.md` must set itself up
and operate after reading `mobile-app-dev-team/09-pod-native-openclaw-skills/README.md`.
...
Recommended aligned Mobile Architect values:
