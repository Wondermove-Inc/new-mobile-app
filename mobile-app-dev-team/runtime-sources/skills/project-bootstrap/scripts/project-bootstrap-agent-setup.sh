...
const [
  ...
  codexInteractiveRepoWorkSkillStatus,
  workspaceAgentsPath,
...
const report = {
  ...
  workspace_skills: {
    ...
    'codex-interactive-repo-work': codexInteractiveRepoWorkSkillStatus,
  },
  workspace_agents: {
