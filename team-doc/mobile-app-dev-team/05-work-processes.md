...
8. For pod-isolated role-agent work, create or update the durable GitHub handoff root under `docs/plans/work-units/<work-unit-id>/` as defined in `10-github-artifact-workflow.md`.
