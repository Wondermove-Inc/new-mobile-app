...
작성일: 2026-06-10
대상 경로: `team-doc/mobile-app-dev-team/`
...
```text
team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks.md
```
...
| 판단 | 결정 |
| --- | --- |
| 문서 위치 | `team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks.md`를 작성한 뒤 README/source-map에 링크해 새 current SoT/runbook으로 승격한다. |
| 계획서 위치 | 이 파일 `team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks-plan.md`에 실행 계획을 둔다. |
...
| `team-doc/mobile-app-dev-team/README.md` | `team-doc/mobile-app-dev-team/`는 운영자가 읽고 유지할 current SoT 영역이다. |
| `team-doc/mobile-app-dev-team/09-pod-native-openclaw-skills/README.md` | 이 폴더는 `/workspace/skills/<slug>/SKILL.md` shape의 source-only pod-native OpenClaw skill 문서 영역이다. |
| `team-doc/mobile-app-dev-team/10-github-artifact-workflow.md` | pod-isolated role agent handoff는 GitHub branch/commit/PR과 `docs/plans/work-units/<work-unit-id>/`를 사용한다. local repo validation은 실제 OrbStack/OpenClaw pod execution을 증명하지 않는다. |
| `team-doc/mobile-app-dev-team/99-source-map.md` | active/historical/current source crosswalk를 유지해야 한다. |
...
| 파일 | 변경 방향 |
| --- | --- |
| `team-doc/mobile-app-dev-team/README.md` | 문서 구조에 `11-openclaw-codex-completion-hooks.md`와 이 계획서를 추가한다. |
| `team-doc/mobile-app-dev-team/99-source-map.md` | `09-pod-native-openclaw-skills/`, `11-openclaw-codex-completion-hooks.md`, boram pod evidence source를 current source map에 추가한다. |
| `team-doc/mobile-app-dev-team/04-skills-and-agents-matrix.md` | `/workspace/codex-hooks`가 OpenClaw skill이 아니라 hook source bundle이라는 경계를 짧게 명시한다. |
| `team-doc/mobile-app-dev-team/06-gates-and-evidence.md` | 다른 agent 적용 시 per-agent E2E evidence가 필요하다는 규칙을 추가한다. |
| `team-doc/mobile-app-dev-team/07-new-team-template-guide.md` | 새 team/agent bootstrap 시 hook source copy와 per-agent state dir 분리 절차를 링크한다. |
...
- `team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks.md` 존재
...
3. `team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks.md`를 작성한다.
...
- `team-doc/mobile-app-dev-team/11-openclaw-codex-completion-hooks.md`가 작성되고 README/source-map에서 링크된다.
